    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: '0acd7257-1c2d-4c96-85f4-81238103b0ae',
            name: name,
            email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שירה דומסקי - מעצבת פנים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
